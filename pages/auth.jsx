              ...
              <div className="card-footer">
                <div className="row">
                  <div className="col-lg-12 d-flex">
                    ...
                    <a className={`tab ${activeTab === "cadastro" ? "active" : ""}`} onClick={() => handleTabClick("cadastro")}>Cadastre-se</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card-footer">
                <div className="row">
                  <div className="col-lg-12 d-flex">
                    ...
                    <a className={`tab ${activeTab === "login" ? "active" : ""}`} onClick={() => handleTabClick("login")}>Login</a>
                  </div>
                </div>
              </div>
            </div>
